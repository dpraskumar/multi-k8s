...
kubectl set image deployments/client-deployment client=dpraskumar/multi-client:$GIT_SHA
kubectl set image deployments/worker-deployment worker=dpraskumar/multi-worker:$GIT_SHA